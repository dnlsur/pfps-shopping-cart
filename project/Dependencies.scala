...
object Dependencies {
  ...
  object V {
    ...
    val log4cats      = "2.3.1"
    val monocle       = "3.1.0"
    val mongoBsonDerivation = "0.20.13"
    val newtype       = "0.4.4"
    val refined       = "0.9.29"
  ...
  object Libraries {
    ...
    val mongo      = "org.mongodb.scala" %% "mongo-scala-driver" % V.mongo
    val mongoBson = "org.mongodb.scala" %% "mongo-scala-bson" % V.mongo
    ...
    val circeMagnolia = "io.circe" %% "circe-magnolia-derivation" % V.circeMagnolia

    val mongoBsonDerivation = "org.reactivemongo" %% "reactivemongo-bson-macros" % V.mongoBsonDerivation
    ...
    val derevoReactivemongo = derevo("reactivemongo")
